...
This document explains the structural prompting, schema validation, post-processing sanitization, and isolated logging design of the internal evaluator model ([agent_worker.py](file:///home/flo/docker-projects/prismdeals/scraper/agent_worker.py)).
...
The python worker [agent_worker.py](file:///home/flo/docker-projects/prismdeals/scraper/agent_worker.py) constructs the prompt using the template [internal_prompt.md](file:///home/flo/docker-projects/prismdeals/prompts/internal_prompt.md). 
...
Rather than failing validation if the model outputs an unexpected category string, the sanitization layer in [agent_worker.py](file:///home/flo/docker-projects/prismdeals/scraper/agent_worker.py) maps the arbitrary strings to a strict, standardized set of frontend types and sentiments:
...
The main application logs [scraper.log](file:///home/flo/docker-projects/prismdeals/data/scraper.log) are handled via `RotatingFileHandler`.
