...
- targets: was gesucht wird, je Ziel "typed" = so genau wie der Käufer es meint
  ("Honda CBR 1000 RR SC59", "Yamaha R1 RN19", "Ventilator", "Corsair Vengeance LPX
  2x16 GB DDR4-3200 CL16"). Mehrere Modelle = mehrere Ziele. Eine Art Ware ohne Modell
  ist ein Ziel ("Kleiderschrank").
- conditions je Ziel, wenn sie nur dieses Ziel betreffen, sonst oben in "conditions":
  ...
  ("Kilometerstand", "Arbeitsspeicher", "Breite"). Nutze die Merkmale der Kategorie,
